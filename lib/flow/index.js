...
App.prototype.def = function (task, deps, fn) {
...
App.prototype.run = function (task, cb) {
...
App.prototype.onerror = function (task, fn) {
  arguments.length == 1
    ? this._onerror_ = task
...
App.prototype.raise = function (task, err) {
...
App.prototype._onerror_ = function (err) {
